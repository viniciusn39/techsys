...
const TENANT_SECTIONS: { label: string; items: MenuItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/erp/painel", module: "painel_erp", icon: "bi-bar-chart-line", label: "Painel do ERP", title: "Painel do ERP", sub: "Faturamento, filiais e rankings com os dados do ERP", roles: ["root", "admin", "gestor"] },
    ],
  },
  {
    label: "Execução",
